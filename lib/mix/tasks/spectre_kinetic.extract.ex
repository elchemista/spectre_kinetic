defmodule Mix.Tasks.SpectreKinetic.Extract do
  use Mix.Task
  ...
  ## Usage
      ...
      mix spectre_kinetic.extract --app my_app --out registry.json
      mix spectre_kinetic.extract --app my_app --encoder artifacts/encoder --out artifacts/registry/registry.etf
  """
