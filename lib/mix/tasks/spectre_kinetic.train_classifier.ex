defmodule Mix.Tasks.SpectreKinetic.TrainClassifier do
  use Mix.Task

  @moduledoc """
  Trains one Axon-backed classifier from JSONL source examples.

      mix spectre_kinetic.train_classifier plan_confidence --dataset data.jsonl --out priv/classifiers/plan_confidence
